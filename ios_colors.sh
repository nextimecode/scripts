...
declare -A darkModeColors=(
    ...
    [SystemCyan]="#64D2FF" # Ciano Celeste Sky Blue
    [SystemBlue]="#0A84FF" #software "Azul Céu Brilhante" Blue Ribbon
    [SystemIndigo]="#5E5CE6" #ciência Índigo Suave Lavender Indigo
    [SystemPurple]="#BF5AF2" #inteligência artificial Roxo Vibrante Heliotrope
